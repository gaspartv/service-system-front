...
export default function SignIn() {
    ...
    const [credentials, setCredentials] = useState(localStorage.getItem(localStorageSavePassword));
    ...
    async function handleCheckboxChange(checked: boolean, values: InitialValuesInterface) {
        ...
        !credentials && localStorage.setItem(localStorageSavePassword, JSON.stringify(values));
    }

    return (
      <div className="min-h-screen bg-cover bg-center flex justify-center items-center" style={{ backgroundImage: 'url(https://assets.nflxext.com/ffe/siteui/vlv3/b5d70d7e-b8ae-4f52-b953-35d922f2f4d9.jpg)' }}>
          <div className="flex flex-col gap-4 bg-zinc-900 bg-opacity-60 p-8 rounded-lg shadow-lg w-96">
              ...
              <Formik
                initialValues={credentials ? JSON.parse(credentials) : {
                    username: '',
                    password: '',
                }}
                    ...
                    <Form className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-4 ">
                          <span>
                            ...
                            <p className="text-xs">Esta página é protegida pelo Google reCAPTCHA para garantir que você
                                não é um
